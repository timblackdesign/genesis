...
function getHeaderOffset(header) {
  var withAnnouncementBar = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
  ...
  if (isSticky) {
    ...
    if (jquery$1(header).hasClass('site-header-sticky--open') || pageYOffset === 0) {
...
var StickyHeader = function () {
  ...
  createClass(StickyHeader, [{
    ...
    key: '_toggleAnnouncementBar',
    value: function _toggleAnnouncementBar() {
      var _this4 = this;
      ...
      if (hide) {
        var mobileOnly = this.$announcementBar.hasClass('only-mobile');
      ...
      this.$el.css('top', top).one('trend', function () {
    ...
    value: function _shrink() {
      ...
      this.$el.revealer('show').one('revealer-animating.sticky-header', function () {
        _this5.$body.addClass(_this5.scrolledClass).one('trend', function () {
    ...
    value: function _expand() {
      ...
      this.$el.revealer('hide').one('revealer-animating.sticky-header', function () {
        _this6.$body.removeClass(_this6.scrolledClass).one('trend', function () {
          _this6.$body.trigger('position-banners');
        });
      }).one('revealer-hide.sticky-header', function () {
        _this6.$toggle.removeClass('active');
      });
    }
  }, {
    key: '_headerChecker',
...
var NavDesktop = function () {
  ...
  createClass(NavDesktop, [{
    ...
    value: function _inlineMenu($menu) {
      ...
      return $menu.css({ maxHeight: maxHeight }).addClass(this.inlineChildren);
    }
  }, {
...
var StaticSectionHeader = function () {
  ...
  createClass(StaticSectionHeader, [{
    ...
    value: function onSectionBlockDeselect() {
      if (this.$menuToggle.hasClass('active') && layout.isBreakpoint('L')) {
  ...
  createClass(MessageBanner, [{
    ...
    value: function dismissBanners() {
      ...
      $visibleBanners.each(function (index, banner) {
        _this2._hide(jquery$1(banner), index);
      });
    }
  }, {
    key: '_bindEvents',
    value: function _bindEvents($banner) {
      ...
      this.events.push([$banner.on('click.message-banner', '[data-message-banner-close]', function (event) {
        ...
        _this3._positionBanner($banner);
      }), this.$window.on('resize.message-banner', justDebounce$1(function () {
        return _this3._positionBanner($banner);
      }, 250)), this.$window.on('scroll.message-banner', function () {
        return _this3._positionBanner($banner);
      })]);
    }
    ...
    value: function _getShippingRates() {
      ...
      Shopify.getCartShippingRatesForDestination(shippingAddress, function (response, shippingAddress) {
        ...
        if (response.length > 1) {
          ...
          message = _this6.shipping.multiple_rates.replace('*address*', address).replace('*number_of_rates*', response.length).replace('*rate*', '<span class="money">' + firstRate + '</span>');
  ...
  createClass(VariantHelper, [{
    ...
    value: function _switchVariantRadio(variant, availableOptions) {
      ...
      var _loop2 = function _loop2(i) {
        var selector = _this3.product.options[i].replace(/"/g, '\\"');
...
var AddToCartFlyout = function () {
  ...
  createClass(AddToCartFlyout, [{
    ...
    key: '_positionFlyOut',
    value: function _positionFlyOut($flyOut) {
  ...
  function Video(el, options) {
    ...
    switch (this.platform) {
      case 'youtube':
        ...
        break;
      case 'vimeo':
        this.video = new VimeoPlayer$1(this.videoEl);
        break;
      default:
        this.video = null;
        break;
...
var ProductGallery = function () {
  ...
  createClass(ProductGallery, [{
    key: 'unload',
    value: function unload() {
      for (var i = 0; i < this.slideImages.length; i += 1) {
    ...
    value: function _init() {
      ...
      if (this.videoSlides.length) {
        for (var _i = 0; _i < this.videoSlides.length; _i += 1) {
          var videoSlide = this.videoSlides[_i];
    ...
    value: function _onSlideImageLoaded() {
      ...
      var activeHeight = this.flickity.selectedElement.offsetHeight;
      var flickityHeight = this.flickity.viewport.offsetHeight;
    ...
    value: function _onVariantChange(variant) {
      ...
      var index = this.$slider.find('[data-product-image=' + variant.featured_image.id + ']').attr('data-product-image-index');
    ...
    value: function _initGallery() {
      ...
      this.flickity = new js$1(this.$slider[0], flickityOptions);
      this._bindGallery();
...
var ProductDetails = function () {
  function ProductDetails(options) {
    ...
    // Form
    this.$form = this.$formArea.find('[data-product-form] form');
    ...
    if (this.time) {
      ...
      if (JSON.parse(localStorage.getItem('recentlyViewed')) !== null) {
        ...
        for (var i = recentlyViewed.length - 1; i >= 0; i--) {
          ...
          var isPlaceholder = recentlyViewed[i].image.indexOf('svg+url') !== 1;
...
var StaticSlideshow = function () {
  ...
  createClass(StaticSlideshow, [{
    ...
    value: function _bindEvents() {
      ...
      this.$window.on('resize.slideshow', justDebounce$1(function () {
    ...
    value: function onSectionBlockSelect(block) {
      ...
      if (this.settings.enable_autoplay) {
        var $slides = jquery$1(this.slides);
        var $slide = jquery$1(block.el);
...
var DynamicTwitterFeed$1 = function () {
  function DynamicTwitterFeed(section) {
    ...
    state.instance.track(this.$wrapper[0]);

    this.$wrapper.on('rimg:enter', function (event) {
      _this._load();
    });
  }
  ...
  createClass(DynamicTwitterFeed, [{
    ...
    value: function _load() {
      ...
      twitterFetcher_min.fetch({
        ...
        'customCallback': function customCallback(tweets) {
          return _this2._renderTweets(tweets);
        },
    ...
    key: 'onSectionUnload',
    value: function onSectionUnload() {
      state.instance.untrack(this.$wrapper[0]);
      this.$window.off('.twitter');
    ...
    value: function _bindSlider() {
      ...
      this.$window.on('resize.twitter', justDebounce$1(function () {
        _this3.$content.trigger('heightUpdate.twitter');
      }));
    ...
    value: function _renderTweets(tweets) {
      ...
      tweets.forEach(function (tweet) {
        ...
        var $template = _this4.$template.clone();
        var authorInfo = _this4._extractAuthor($tweet[0]);
        var meta = _this4._extractMeta($tweet[2]);
      ...
      this.$tweets.fadeOut().promise().then(function () {
        _this4._destroyFlickity();
        _this4.$tweets.remove();

        _this4.$content.append(tweetsArray);

        _this4.$wrapper.removeClass(_this4._extractWrapperClass()).addClass(wrapperClass).css('min-height', '');

        _this4.$tweets = _this4.$el.find('[data-tweet-content]');

        _this4._evenHeights();
        _this4._mobileSlider();
      });
    }
  }]);
  return DynamicTwitterFeed;
...
var DynamicInstagramFeed = function () {
  function DynamicInstagramFeed(section) {
    ...
    state.instance.track(this.$photoContainer[0]);

    this.$photoContainer.on('rimg:enter', function (event) {
      _this._load();
    });
  }
  ...
  createClass(DynamicInstagramFeed, [{
    ...
    value: function _load() {
      ...
      this._getPhotos().done(function (photos) {
        return _this2._renderPhotos(photos);
      }).fail(function (error) {
    ...
    value: function _renderPhotos(photos) {
      ...
      photos.forEach(function (photo) {
        var $template = _this3.$photoTemplate.clone();
      ...
      this.$photoContainerPlaceholder.fadeOut(function () {
        ...
        _this3.$photoContainer.append(photoArray);
        _this3.$photoContainerPlaceholder.remove();
    ...
    value: function _bindSlider() {
      ...
      this.$window.on('resize.instagram-feed', justDebounce$1(function () {
        _this4.$photoContainer.trigger('heightUpdate.instagram-feed');
      }));
      ...
      this.$photoContainer.on('heightUpdate.instagram-feed', function () {
        ...
        $slider.height(Math.ceil(_this4.flickity.maxCellHeight));
      });
    ...
    key: 'onSectionUnload',
    value: function onSectionUnload() {
      state.instance.untrack(this.$photoContainer[0]);
    }
  }]);
...
var StaticSectionHeader$2 = function () {
  function StaticSectionHeader(section) {
    var _this = this;
...
var DynamicTwitterFeed$3 = function () {
  function DynamicTwitterFeed(section) {
    var _this = this;
    ...
    this.$el.find('[data-rte]').each(function (i, el) {
      _this.rte.push(new RichText(jquery$1(el)));
    });
  }
...
var DynamicNewsletter = function () {
  function DynamicNewsletter(section) {
    classCallCheck(this, DynamicNewsletter);
...
sections.register('dynamic-rich-text', function (section) {
  return new DynamicTwitterFeed$3(section);
});
